...
- [x] Trace 审计与不含运行时敏感文件的证据导出
- [x] Tier 1 三策略三次重复、隐藏验证与编辑/恢复/压缩指标
- [ ] Tier 2：8–12 个带上游来源和许可证的真实仓库任务（当前 1 个 pilot）
- [ ] Tier 3：SWE-bench Lite / 开源 Issue 适配器
- [x] 离线 HTML 单次运行报告
- [x] 多模型、多策略 HTML 对比报告与逐任务矩阵
